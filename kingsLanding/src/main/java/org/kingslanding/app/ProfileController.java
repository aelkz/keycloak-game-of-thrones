...
public class ProfileController {
    ...
    public String getAccountUri(HttpServletRequest req) {
        ...
        String accountURI = KeycloakUriBuilder.fromUri(baseUrl).path(ServiceUrlConstants.ACCOUNT_SERVICE_PATH)
                .queryParam("referrer", "rh-sso-app-profile-jee-jsp")
                .queryParam("referrer_uri", getReferrerUri(req)).build(realm).toString();

        System.out.println(accountURI);
        return accountURI;
    }
