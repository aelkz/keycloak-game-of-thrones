...
<div class="wrapper" id="welcome">
    ...
    <div class="content">
        <b>KING'S LANDING APPLICATION</b>
        <div class="message">
            <img src="styles/icon.png" style="position: relative;" height="201px" width="180px"/>
            Please login if you respect <b>Cersei Lannister</b>!
        </div>
    </div>
</div>
</body>
